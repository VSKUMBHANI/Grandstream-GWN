...
ID_ENV = '103497' # Retrieved from the GDMS Cloud API Developer Portal.
SECRET_KEY_ENV = 'rb9nFH62UrYFJ7WBCTHnenNheSyi2rey' # Retrieved from the GDMS Cloud API Developer Portal.
